...
| `e2e/package.json` | Playwright (`@playwright/test`) — the E2E runner and browser-download tooling — and `@axe-core/playwright` for the accessibility checks the E2E tests run. | Hand-edited. |
